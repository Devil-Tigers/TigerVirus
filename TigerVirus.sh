...
echo " "
echo -e "\e[33m Welcome to [\e[1m\e[32mTIGER VIRUS\e[21m\e[33m]"
echo " "
sleep 1
echo -e "\e[1m\e[33m============================================\e[21m"
echo " "
echo -e "\e[33m•••Script by \e[36mTIGER HACK MALAYALAM\e[33m•••"
echo " "
echo -e "\e[1m\e[33m••••••••••••••••••••••••••••••••••••••••••••\e[21m"
echo " "
sleep 1
...
pkg install man -y
echo " "
echo -e "\e[35mAll PACKAGES Installed Successfully"|pv -qL 20
echo " "
echo -e "\e[1m\e[33m^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\e[21m"
...
echo -e "\e[103mSEARCH *TIGER HACK MALAYALAM*"
